export const skillsStyle = [
  ...
  {
    id: 4,
    path: "/images/skills/material.png",
    alt: "material ui logo",
    label: "Material UI"
  },
  {
    id: 5,
    path: "/images/skills/bootstrap.png",
    alt: "bootstrap logo",
    label: "Bootstrap"
  },
  {
...
export const skillsJs = [
  {
    id: 1,
    path: "/images/skills/js.png",
    alt: "javascript logo",
    label: "Javascript"
  },
  {
    id: 2,
    path: "/images/skills/jquery.png",
    alt: "jquery logo",
    label: "JQuery"
  },
  {
  ...
  {
    id: 4,
    path: "/images/skills/next.png",
    alt: "next js logo",
    label: "Next JS"
  },
  {
    id: 5,
    path: "/images/skills/node.png",
    alt: "node js logo",
    label: "Node JS"
  },
  {
